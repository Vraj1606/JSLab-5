...
// STEP 3c: Update the charge level
    ...
    const url =`https://robohash.org/${battery.level*100}percent.png?set=set3`;
    const imageDisplayContainer = document.createElement('img');
    imageDisplayContainer.src = url;    
    imageDisplay.appendChild(imageDisplayContainer);
}
